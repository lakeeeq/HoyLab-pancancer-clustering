...
input <- data.frame( read_excel("Figure1c/figure1c_input.xlsx") )
...
# using the cluster groups as determined in Figure1b based on the metabolites 
split <- c( rep(3, 14) , rep(4,12) , rep(2, 15) , rep(1, 16) )
